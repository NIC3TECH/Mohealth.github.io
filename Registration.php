...
$stmt = $conn->prepare("INSERT INTO sign_up_tb (fname, lname, fpassword, NIC, nphone, Age, gender) VALUES (?, ?, ?, ?, ?, ?, ?)");
if (!$stmt) {
    die("Error preparing statement: " . $conn->error);
}
$stmt->bind_param("ssssiis", $firstname, $lastname, $hash, $id, $phone, $age, $gender);
